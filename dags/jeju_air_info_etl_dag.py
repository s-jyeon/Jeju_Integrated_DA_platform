...
s3_to_redshift = S3ToRedshiftOperator(
    ...
    table='jeju_air_info',    # 적재할 Redshift 테이블 이름
    s3_bucket='ip-jeju-airflow',
    s3_key='data/transformed/jeju_air_info/',
...
DATA_SET_ID = "3c43b981-d863-402d-9b1d-3cc302922fec"  # QuickSight 데이터 세트 ID
import datetime

# 현재 날짜와 시간으로 고유한 ingestionId 생성
INGESTION_ID = f"jeju_air_info_refresh_ingestion_{datetime.datetime.now().strftime('%Y%m%d%H%M%S')}"
