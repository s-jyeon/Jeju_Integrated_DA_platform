...
# 설정
DATA_SET_ID = "b697e3f1-cd7e-4d01-8fe6-9831d9115c58"         # QuickSight 데이터 세트 ID
INGESTION_ID = f"jeju_floating_population_of_foreigners-{datetime.now().strftime('%Y%m%d%H%M%S%f')}"      # 고유 SPICE 새로고침 작업 ID
REGION_NAME = "ap-northeast-2"
GLUE_JOB_1 = "jeju_floating_population_of_foreigners"
S3_BUCKET = "ip-jeju-airflow"
S3_KEY = "data/transformed/jeju_floating_population_of_foreigners/"
...
# DAG 정의
with DAG(
    dag_id="jeju_floating_population_of_foreigners",
    ...
    load_to_redshift = S3ToRedshiftOperator(
        ...
        schema = 'jeju_tourist',
        table = 'jeju_floating_population_of_foreigners',
        s3_bucket = S3_BUCKET,
        s3_key = S3_KEY,
