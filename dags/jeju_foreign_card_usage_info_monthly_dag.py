...
# 설정
DATA_SET_ID = "21cccfd0-bcc6-4197-a265-01ace430e996"
INGESTION_ID = f"jeju_foreign_card_usage_info_monthly-{datetime.now().strftime('%Y%m%d%H%M%S%f')}"
REGION_NAME = "ap-northeast-2"
GLUE_JOB_1 = "jeju_foreign_card_usage_info_monthly"
S3_BUCKET = "ip-jeju-airflow"
S3_KEY = "data/transformed/jeju_foreign_card_usage_info_monthly/"
...
# DAG 정의
with DAG(
    dag_id="jeju_foreign_card_usage_info_monthly",
    ...
    load_to_redshift = S3ToRedshiftOperator(
        ...
        table = 'jeju_foreign_card_usage_info_monthly',
        s3_bucket = S3_BUCKET,
        s3_key = S3_KEY,
