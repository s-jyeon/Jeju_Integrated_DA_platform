...
# 설정
DATA_SET_ID = "77d82e22-0896-4f30-ad45-fc5350821aa0"
INGESTION_ID = f"jeju_foreign_tourist_spot_counts_trend-{datetime.now().strftime('%Y%m%d%H%M%S%f')}"
REGION_NAME = "ap-northeast-2"
GLUE_JOB_1 = "jeju_foreign_tourist_spot_counts_trend"
S3_BUCKET = "ip-jeju-airflow"
S3_KEY = "data/transformed/jeju_foreign_tourist_spot_counts_trend/"
...
# DAG 정의
with DAG(
    dag_id="jeju_foreign_tourist_spot_counts_trend",
    ...
    load_to_redshift = S3ToRedshiftOperator(
        ...
        schema = 'jeju_tourist',
        table = 'jeju_foreign_tourist_spot_counts_trend',
        s3_bucket = S3_BUCKET,
        s3_key = S3_KEY,
