...
# 설정
INGESTION_ID = f"jeju_lodge_customer_inflow_country_info-{datetime.now().strftime('%Y%m%d%H%M%S%f')}"
DATA_SET_ID = "b832e5c7-e4c4-4226-9e4a-e685ff98ed6b"
REGION_NAME = "ap-northeast-2"
GLUE_JOB_1 = "lodge_customer_inflow_country_info"
S3_BUCKET = "ip-jeju-airflow"
S3_KEY = "data/transformed/jeju_lodge_customer_inflow_country_info/"
...
# DAG 정의
with DAG(
    dag_id="jeju_lodge_customer_inflow_country_info",
    ...
    load_to_redshift = S3ToRedshiftOperator(
        ...
        schema = 'jeju_tourist',
        table = 'jeju_lodge_customer_inflow_country_info',
        s3_bucket = S3_BUCKET,
        s3_key = S3_KEY,
