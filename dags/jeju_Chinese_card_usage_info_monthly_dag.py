...
# API URL
base_url = "https://open.jejudatahub.net/api/proxy/tt1tDtaa0at16Daa0D60D06tDD0166t1/{your_appkey}".replace("{your_appkey}", your_appkey)
...
S3_KEY = "data/transformed/jeju_Chinese_card_usage_info_monthly/"
folder_name = "data/raw/jeju_Chinese_card_usage_info_monthly/"
json_file_name = "jeju_Chinese_card_usage_info_monthly.json"
csv_file_name = "jeju_Chinese_card_usage_info_monthly.csv"
...
# Save data to S3 using S3Hook
    try:
        ...
        # Upload JSON file
        s3_hook.load_string(
            string_data=json.dumps(all_data, ensure_ascii=False, indent=4),
...
# 설정
DATA_SET_ID = "1aeaa7c1-f4bd-49c9-ad1a-4b14ced470d7"
INGESTION_ID = f"jeju_Chinese_card_usage_info_monthly-{datetime.now().strftime('%Y%m%d%H%M%S%f')}"
REGION_NAME = "ap-northeast-2"
GLUE_JOB_1 = "jeju_Chinese_card_usage_info_monthly_1"

with DAG(
    dag_id = 'jeju_Chinese_card_usage_info_monthly',
    default_args = default_args,
    description = 'API 데이터 수집 후 시각화 데이터셋',
    ...
    load_to_redshift = S3ToRedshiftOperator(
        ...
        table = 'jeju_Chinese_card_usage_info_monthly',
